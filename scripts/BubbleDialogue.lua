...
-- ---------------------------------------------------------------------------
-- 白夜气泡对话池 (白夜主动发言的碎碎念，静止时有一定概率弹出)
-- 这些走的是白夜视角：观察力强、说话奇怪、偶尔捉弄苏柚
-- ---------------------------------------------------------------------------
local BAIYE_LINES = {
    "我刚才闻到隔壁在煮泡面，你能去要一碗吗？我出五块钱。",
    "那个红绿灯坏了吧？它闪了七次红灯，一次绿灯都没亮过。",
    "你注意到那只鸽子一直在盯着你吗？它可能是我上辈子的仇人。",
    "别捡地上的钱。那不是钱，是诱饵。",
    "这条斑马线画得不对。少画了一横，走上去会掉进昨天。",
    "你鞋带松了。……骗你的。",
    "那个外卖小哥的箱子里装的不是饭，是一窝刚孵化的影子。",
    "你手机没电了？我可以给你充，但充完你的相册里会多三张我的自拍。",
    "别对着自动门做鬼脸。它记仇的，下次会夹你。",
    "前面那个人走路没有影子。……哦，是我看错了，他把影子穿在背后。",
    "你信不信我现在打个响指，对面的奶茶店就会多送一杯过来？……不信？我也不信。",
    "那只流浪猫说它讨厌你今天的香水味。我翻译得对吧？",
    "电梯里那个按钮「B3」是假的，按了会送你到B2，然后门打不开。",
    "你的耳机在漏音。左边放的是《甜蜜蜜》，右边是恐怖片配乐。",
    "我数到三，你身后那棵树会掉一片叶子砸你头。一、二、……算了，它今天害羞。",
    "下雨了？那不是雨，是楼上的云在浇花。",
    "你刚才跟自动售货机说了谢谢？它记住了，下次会多找你五毛。",
    "别回头看那个广告牌。上面的模特在换姿势，她不想被人看见。",
    "你鞋里有一颗石子。……我怎么知道的？我刚才在鞋里放了一颗。",
    "那个红裙子的女人又来了。别慌，她只是觉得你今天的发型很好看。",
}
...
local function pickLine(bubble)
    ...
    -- 白夜碎碎念 (权重 1, 加前缀区分说话人)
    -- 约占总池 ~30%，不抢主角戏份但存在感足
    for _, line in ipairs(BAIYE_LINES) do
        candidates[#candidates + 1] = "白夜：" .. line
    end
