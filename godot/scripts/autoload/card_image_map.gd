...
const LOCATION_EVENT_IMAGES: Dictionary = {
	"company": {
		...
		"plot":   ["evt_company_email_clue_20260512105926.png"],
	},
	"school": {
		"safe":   ["evt_school_quiet_study_20260512104512.png"],
		"plot":   ["evt_school_plot_backpack_20260515100613.png", "evt_school_old_notebook_20260512104523.png"],
	...
	"park": {
		...
		"plot":   ["evt_park_nature_clue_shaft_20260515083206.png"],
	},
	"alley": {
		...
		"plot":    ["evt_alley_graffiti_clue_shaft_20260515083204.png"],
	},
	"station": {
		...
		"plot":    ["evt_station_schedule_clue_20260512112025.png"],
	},
	"hospital": {
		...
		"plot":    ["evt_hospital_medical_record_20260512180052.png"],
	},
	"library": {
	...
	"bank": {
		...
		"plot":  ["evt_bank_suspicious_record_20260512181419.png"],
	},
	"cemetery": {
		...
		"plot":   ["evt_cemetery_epitaph_clue_20260512182458.png"],
	},
	"gym": {
		...
		"plot":    ["evt_gym_bandage_clue_20260512182832.png"],
	},
}
