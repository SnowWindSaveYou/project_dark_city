...
@onready var _event_texture: TextureRect = $PhotoAnchor/PhotoFrame/VBox/EventTexture
@onready var _bg_fill: ColorRect = $PhotoAnchor/PhotoFrame/VBox/EventTexture/BgFill
@onready var _icon_label: Label = $PhotoAnchor/PhotoFrame/VBox/EventTexture/IconLabel
@onready var _scout_badge: Label = $PhotoAnchor/PhotoFrame/VBox/EventTexture/ScoutBadge
@onready var _chibi_overlay: TextureRect = $PhotoAnchor/PhotoFrame/VBox/EventTexture/ChibiOverlay
